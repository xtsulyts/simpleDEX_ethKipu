...
/**
 * Página principal para interactuar con el contrato TokenA
...
const TokenA: NextPage = () => {
   ...
   * Usa la función balanceOf del contrato TokenA
   */
  ...
  const { writeContractAsync: transfer } = useScaffoldWriteContract("TokenA");
  const { writeContractAsync: approve } = useScaffoldWriteContract("TokenA");
  const { writeContractAsync: burn } = useScaffoldWriteContract("TokenA");
  const { writeContractAsync: transferFrom } = useScaffoldWriteContract("TokenA");
      ...
      <div className="flex items-center flex-col text-center mt-8 p-10">
        ...
        <div className="card bg-base-100 w-96 shadow-xl mb-6">
          <div className="card-body">
            <h1 className="text-4xl my-0">Token A (TKA)</h1>
            <div className="stats shadow">
              <div className="stat">
                ...
                <div className="stat-desc">Tokens TKA</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card-body">
            ...
            {currentAllowance && (
              <div className="text-sm text-gray-600">
                Allowance actual: {formatEther(currentAllowance)} TKA
              </div>
            )}
